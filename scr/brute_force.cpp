...
// Returns the maximum value that can be put in a scr of capacity weight_max
int brute_force(size_t weight_max, std::vector<size_t> &weight, std::vector<size_t> &value) {
